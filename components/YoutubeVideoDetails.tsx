      ...
      <div className="flex flex-col gap-8">
        <div className="flex-shrink-0">
          <Image
            ...
            width={500}
            height={500}
            className="w-full rounded-xl shadow-md hover:shadow-xl transition-shadow duartion-300"
          />
        </div>

        {/* video details */}
        <div className="flex-grow space-y-4">
          <h1 className="text-2xl @lg:text-3xl font-bold text-hray-900 leading-tight line-clamp-2">
            {video.title}
          </h1>
          ...
          <div className="grid grid-cols-2 @lg:grid-cols-4 gap-4 pt-4">
            ...
            <div className="bg-gray-50 rounded-lg p-3 transition-all duration-300 hover:bg-gray-100">
                ...
                <p className="font-medium text-gray-900">{video.comment}</p>
            </div>
